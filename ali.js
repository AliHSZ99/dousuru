$(document).ready(function(){
    ...
    $("#b1").click(function(){
        ...
        "goal was to make an OMNIVOX LEA similutor. We had to do so by creating a Login frame, an Admin frame, a Student frame " +
        "and a Teacher frame.");
        $("#project-img").attr("src", "/imgs/p2img.png");
        $("#downloadable-file").attr("href", "prog2FinalProjectAli.zip");
    });
    ...
    $("#b3").click(function(){
        ...
        $("#downloadable-file").attr("href", "WarAli.zip");
    });
    ...
    $("#b4").click(function(){
        ...
        $("#downloadable-file").attr("href", "AliCookiesAssignment.zip");
    });
